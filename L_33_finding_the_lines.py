...
# <img src="l33-warped-example.jpg" width=500 align="left" />
...
# <img src="l33-histogram-example.png" width=700 align="left" />
# <div style="clear:both"></div>
# 
# 
# #### Sliding Window  
...
# 
# I can use that as a *starting point for where to search for the lines*. From that point,  
# I can use a **sliding window** placed around the line centers, to find and **follow the lines up** to the top of the frame.  

# ### Implement Sliding Windows and Fit a Polynomial  
# Suppose you've got a warped binary image called binary_warped and  
# you want to find which "hot" pixels are associated with the lane lines.  
# 
# Here's a basic implementation of the method shown in the animation above.  
# You should think about how you could improve this implementation to make sure you can  
# find the lines as robustly as possible!
# 
# 
...
# 
# <img src="l33-visualize-sliding-window-and-lane-lines-example.png" width=500 align="left" align="left" />
# <div style="clear:both"></div>  
# 

# ### Searching from Previous Lane Line Position
...
# #### The output should look something like this:
# <img src="l33-lane-lines-result-example.png" width=500 align="left"/>
# <div style="clear:both"></div>
# 
# The green shaded area shows where we searched for the lines this time.  
# 
# So, once you know where the lines are in one frame of video, you can do  
# a highly targeted search for them in the next frame.  
# 
